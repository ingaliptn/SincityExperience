...
namespace ConsoleApp.Lib
{
    public class CsvToBd
    {
        ...
        public async Task AddEscort1(string siteName, string fileName, int fileNumber)
        {
            var path = $@"D:\!Download\{fileName}";
            using var reader = File.OpenText(path);
            var fileText = await reader.ReadToEndAsync();
            ...
            foreach (var p in list)
            {
                ...
                var es = new Escort { SiteName = siteName, Bust = fileNumber};
                ...
                if (!string.IsNullOrEmpty(line[2])) es.Section = line[2];
                if (!string.IsNullOrEmpty(line[3])) es.EscortName = line[3];
                if (!string.IsNullOrEmpty(line[4]))
                {
                    var f = int.TryParse(line[4], out var age);
                    if (f) es.Age = age;
                }
                //if (!string.IsNullOrEmpty(line[4]))
                //{
                ...
                if (!string.IsNullOrEmpty(line[23])) es.City = line[23];
        ...
        public async Task AddEscort3(string siteName, string fileName, int fileNumber)
        {
            var path = $@"D:\!Download\{fileName}";
            using var reader = File.OpenText(path);
            var fileText = await reader.ReadToEndAsync();
            ...
            foreach (var p in list)
            {
                ...
                if (line.Length > 23 && !string.IsNullOrEmpty(line[23])) es.City = line[23];
        ...
        public async Task AddEscort4(string siteName, string fileName, int fileNumber)
        {
            var path = $@"D:\!Download\{fileName}";
            using var reader = File.OpenText(path);
            var fileText = await reader.ReadToEndAsync();
        ...
        public async Task AddSiteTitleSiteDescriptionNew(string siteName, string fileName)
        {
            ...
            foreach (var p in list)
            {
                ...
                if (line[0] == "https://www.sincityexperience.com/all.php")
                {
                    txtTitle.Description = line[1];
                    txtDescription.Description = line[2];
                    txtTitle.Position = "SiteTitleAll";
                    txtDescription.Position = "SiteDescriptionAll";
                }
                else
                if (line[0] == "https://www.sincityexperience.com/")
                {
                    txtTitle.Description = line[1];
                    txtDescription.Description = line[2];
        ...
        public async Task AddSiteTitleSiteDescription(string siteName, string fileName)
        {
            ...
            foreach (var p in list)
            {
                ...
                if (line[0] == $"https://{siteName}/all.php")
                {
                    txtTitle.Description = line[1];
                    txtDescription.Description = line[2];
                    txtTitle.Position = "SiteTitleAll";
                ...
                if (line[0].Contains("escort-profile-new.php"))
                {
                    txtTitle.Description = line[1];
                    txtDescription.Description = line[2];
                    txtTitle.Position = $"SiteTitleEscortProfileNew";
                    txtDescription.Position = $"SiteDescriptionEscortProfileNew";
                }
                else
